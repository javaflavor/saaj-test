 ...
 * 
 */
@WebServiceClient(name = "CalcService", targetNamespace = "http://calc.example.redhat.com/", wsdlLocation = "http://localhost:8080/calc-ws/CalcService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCSERVICE_QNAME = new QName("http://calc.example.redhat.com/", "CalcService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/calc-ws/CalcService?wsdl");
    ...
    public Calc getCalcPort() {
        return super.getPort(new QName("http://calc.example.redhat.com/", "CalcPort"), Calc.class);
    }
    ...
    public Calc getCalcPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calc.example.redhat.com/", "CalcPort"), Calc.class, features);
    }
